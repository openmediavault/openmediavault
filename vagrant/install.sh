...
# deb http://packages.openmediavault.org/public stoneburner-proposed main
# deb http://downloads.sourceforge.net/project/openmediavault/packages stoneburner-proposed main
## This software is not part of OpenMediaVault, but is offered by third-party
## developers as a service to OpenMediaVault users.
# deb http://packages.openmediavault.org/public stoneburner partner
# deb http://downloads.sourceforge.net/project/openmediavault/packages stoneburner partner
EOF
