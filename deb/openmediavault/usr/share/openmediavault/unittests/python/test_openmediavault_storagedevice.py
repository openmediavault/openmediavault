...
class StorageDeviceTestCase(unittest.TestCase):
    ...
    @mock.patch(
        'openmediavault.subprocess.check_output',
        return_value='\n'.join(['ID_ATA_ROTATION_RATE_RPM=0']).encode()
    )
    ...
    @mock.patch(
        'openmediavault.subprocess.check_output',
        return_value='\n'.join(['ID_ATA_ROTATION_RATE_RPM=1000']).encode()
    )
    ...
    @mock.patch(
        'openmediavault.subprocess.check_output',
        return_value='\n'.join(['ID_ATA_FEATURE_SET_AAM=0']).encode()
    )
    ...
    @mock.patch(
        'openmediavault.subprocess.check_output',
        return_value='\n'.join(['ID_ATA_FEATURE_SET_AAM=1']).encode()
    )
    ...
    @mock.patch(
        'openmediavault.subprocess.check_output', return_value=''.encode()
    )
