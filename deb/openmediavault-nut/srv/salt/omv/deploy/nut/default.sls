...
{% set admin_passwd = salt['pillar.get']('default:OMV_NUT_UPSDUSERS_ADMIN_PASSWORD', salt['random.get_str'](32, punctuation=False)) | replace('#', '\#') | replace('=', '\=') %}
{% set monitor_user = salt['pillar.get']('default:OMV_NUT_UPSDUSERS_MONITOR_USER', 'monmaster') %}
{% set monitor_passwd = salt['pillar.get']('default:OMV_NUT_UPSDUSERS_MONITOR_PASSWORD', salt['random.get_str'](32, punctuation=False)) | replace('#', '\#') | replace('=', '\=') %}
