...
if ! omv_config_exists "/config/services/nut"; then
	...
	omv_config_add_key "/config/services/nut" "nutserver" ""
	omv_config_add_key "/config/services/nut" "nutserverlogin" ""
	omv_config_add_key "/config/services/nut" "nutserverpassword" ""
